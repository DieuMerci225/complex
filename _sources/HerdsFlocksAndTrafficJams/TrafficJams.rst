...
.. figure:: Figures/Traffic_Jam.gif
    :align: center
    :alt: "Gif: Simulation of traffic jams. Squares indicate the position of the drivers; triangles indicate places where one driver has to brake to avoid another."

    Gif: Simulation of traffic jams. Squares indicate the position of the drivers; triangles indicate places where one driver has to brake to avoid another.
